      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <li>
              <a href="{{ route('pengajuan_barang_user') }}" class="nav-link px-3 {{ ($title == 'Daftar Permintaan Barang')? 'active' : '' }}">
            ...
            <div class="mb-4">
              ...
              <div class="collapse" id="layouts">
                <ul class="navbar-nav ps-3">
                  <li>
                    <a href="{{ route('laporan_pengajuan_barang_user') }}" class="nav-link px-3 {{ ($title == 'Laporan Permintaan Barang')? 'active' : '' }}">
                      <span class="me-2"
          ...
          <li>
            <a href="{{ route('pengajuan_barang_admin') }}" class="nav-link px-3 {{ ($title == 'Daftar Permintaan Barang')? 'active' : '' }}">
              <span class="me-2"><i class="fa-solid fa-right-to-bracket"></i></span>
              <span>Permintaan Barang</span>
            </a>
          </li>
          ...
          {{-- <div class="mb-4">
            ...
            <div class="collapse" id="layouts">
              <ul class="navbar-nav ps-3"> --}}
                <li>
                  <a href="{{ route('laporan_pengajuan_barang_admin') }}" class="nav-link px-3 {{ ($title == 'Laporan Permintaan Barang')? 'active' : '' }}">
                ...
                <li>
                  <a href="{{ route('laporan_barang_keluar_admin') }}" class="nav-link px-3 {{ ($title == 'Laporan Pemakaian Barang')? 'active' : '' }}">
                    <span class="me-2"><i class="fa-solid fa-clipboard"></i></span>
                    <span>Laporan Pemakaian Barang</span>
                  </a>
                </li>
              {{-- </ul>
