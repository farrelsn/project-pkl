...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" class="row g-3" action="{{ route('kategori_barang_user.update',[$kategori_barang->id]) }}" class="forms-sample">
                @csrf
                ...
                <div class="col-12 text-end mt-2">
                    ...
                    <a href="{{ route('kategori_barang_user') }}" class="btn btn-sm btn-dark mb-0">Back</a>
                </div>
            </form>
        </div>
    </div>
