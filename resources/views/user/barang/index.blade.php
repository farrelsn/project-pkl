                ...
                <tbody>
                  ...
                  <tr style="white-space: nowrap;">
                    ...
                    <td class="text-center">
                      <a class="btn btn-dark btn-sm" href="{{ route('data_barang_user.edit', [$item->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                      <a class="btn btn-danger btn-sm" href="{{ route('data_barang_user.delete', [$item->id]) }}" onclick="return confirm('Apa anda yakin ingin menghapusnya?')"><i class="fa-solid fa-trash-can"></i></a></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
