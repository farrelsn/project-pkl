...
@section('content')
    ...
    @endif
      <h3>{{ $title }}</h3>
      {{-- @if ($laporan_barang_keluar->count() > 0) --}}
      <div class="card">
        <div class="card-body">
          <div class="row mb-4">
            <form action="{{ route('laporan_barang_keluar_user.action') }}" method="POST">
              @csrf
              <div class="row g-3">
                <div class="col">
              ...
              <div class="row mt-3">
                <div class="col">
                  ...
                  <a href="{{ route('laporan_barang_keluar_user') }}" class="btn btn-secondary">Reset</a>
          ...
          <div class="table-responsive">
            <table id="example" class="display" style="width: 100%" cellspacing="0">
                ...
                <tbody style="white-space: nowrap">
                  @foreach ($laporan_barang_keluar as $item)
                  <tr>
                    ...
                    <td><a class="btn btn-danger btn-sm" href="{{ route('laporan_barang_keluar_user.delete', [$item->id]) }}" onclick="return confirm('Apa anda yakin ingin menghapusnya?')"><i class="fa-solid fa-trash-can"></i></a></td></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
