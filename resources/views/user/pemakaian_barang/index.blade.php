...
@section('content')
                ...
                <tbody style="white-space: nowrap">
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a class="btn btn-success btn-sm" href="{{ route('pemakaian_barang_user.storelaporan', [$item->id]) }}" onclick="return confirm('Konfirmasi pemakaian barang?')"><i class="fa-solid fa-check"></i></a>
                      <a class="btn btn-danger btn-sm" href="{{ route('pemakaian_barang_user.delete', [$item->id]) }}" onclick="return confirm('Apa anda yakin ingin menghapusnya?')"><i class="fa-solid fa-trash-can"></i></a></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div id="showModalTambahBarang">
                    <form action="{{ route('pemakaian_barang_user.store') }}" method="post">
                        @csrf
    ...
    <script>
      ...
      $(document).on('change', '#nama_barang', function(){
        var id = this.value;
        $.ajax({
          url: "{{ route('pemakaian_barang_user.getstok') }}",
          type: "POST",
          data: {
            id:id,
            _token: '{{ csrf_token() }}'},
      ...
      $(document).on('input', '#jumlah', function(){
        ...
        $.ajax({
          url: "{{ route('pemakaian_barang_user.changestok') }}",
          type: "POST",
          data: {
            jumlah:jumlah,
            id:id,
