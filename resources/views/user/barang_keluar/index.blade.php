                ...
                <tbody style="white-space: nowrap">
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a class="btn btn-success btn-sm" href="{{ route('barang_keluar_user.storelaporan', [$item->id]) }}" onclick="return confirm('Konfirmasi pemakaian barang?')"><i class="fa-solid fa-check"></i></a>
                      <a class="btn btn-danger btn-sm" href="{{ route('barang_keluar_user.delete', [$item->id]) }}" onclick="return confirm('Apa anda yakin ingin menghapusnya?')"><i class="bi bi-trash-fill"></i></a></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
