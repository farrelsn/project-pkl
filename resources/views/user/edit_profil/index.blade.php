            ...
            <div class="row mt-1 mb-1">
                <div class="form-group">
                    <div class="text-center">
                        <div class="container">
                            <img id="pp" style="width: 200px; height: 200px" class="border border-white border-3 rounded-circle" src="{{ $user->foto == null ? asset('assets/images/default.jpg') : asset('assets/images/foto_profil/'. $user->foto) }}" alt="..." onerror="this.onerror=null;this.src='{{asset('assets/images/default.jpg')}}';">
                        </div>
                        <div class="form-group">
