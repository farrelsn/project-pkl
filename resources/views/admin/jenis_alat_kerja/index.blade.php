                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a class="btn btn-dark" href="{{ route('jenis_alat_kerja_admin.edit', [$item->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                      <a class="btn btn-danger" href="{{ route('jenis_alat_kerja_admin.delete', [$item->id]) }}" onclick="return confirm('Apa anda yakin ingin menghapusnya?')"><i class="fa-solid fa-trash-can"></i></a></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div id="showModalTambahAlatKerja">
                    <form action="{{ route('jenis_alat_kerja_admin.store') }}" method="post">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-12">
                                    <label for="jenis_alat_kerja" class="col-form-label">Jenis Alat Kerja</label>
                                    <input type="text" class="form-control" id="jenis_alat_kerja" name="jenis_alat_kerja" value="" required>
                                </div>
                            </div>
                        </div>
