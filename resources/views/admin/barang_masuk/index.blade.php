                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a class="btn btn-danger" href="{{ route('barang_masuk_admin.delete', [$item->id]) }}" onclick="return confirm('Apa anda yakin ingin menghapusnya?')"><i class="bi bi-trash-fill"></i></a></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div id="showModalTambahBarang">
                    <form action="{{ route('barang_masuk_admin.store') }}" method="post">
                        @csrf
