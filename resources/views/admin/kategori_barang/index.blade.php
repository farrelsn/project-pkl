                ...
                <tbody>
                  ...
                  <tr style="white-space: nowrap;">
                    ...
                    <td class="text-center">
                      <a class="btn btn-dark btn-sm" href="{{ route('kategori_barang_admin.edit', [$item->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                      <a class="btn btn-danger btn-sm" href="{{ route('kategori_barang_admin.delete', [$item->id]) }}" onclick="return confirm('Semua data barang dengan kategori ini akan ikut dihapus. Apa anda yakin ingin menghapus kategori ini?')"><i class="fa-solid fa-trash-can"></i></a></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div id="showModalTambahBarang">
                    <form action="{{ route('kategori_barang_admin.store') }}" method="post">
                        @csrf
