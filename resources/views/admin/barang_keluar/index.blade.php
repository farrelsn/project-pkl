            ...
            <table id="example" class="display" style="width: 100%" cellspacing="0">
                ...
                <tbody style="white-space: nowrap">
                  ...
                  <tr>
                    ...
                    <td>{{ $item->barang->stok - $item->jumlah_barang }}</td>
                    <td class="text-center">
                      {{-- <a class="btn btn-dark" href="{{ route('barang_masuk_admin.edit', [$item->id]) }}"><i class="bi bi-pencil-fill"></i></a> --}}
                      <a class="btn btn-success btn-sm" href="{{ route('barang_keluar_admin.storelaporan', [$item->id]) }}" onclick="return confirm('Konfirmasi pemakaian barang?')"><i class="fa-solid fa-check"></i></a>
                      <a class="btn btn-danger btn-sm" href="{{ route('barang_keluar_admin.delete', [$item->id]) }}" onclick="return confirm('Apa anda yakin ingin menghapusnya?')"><i class="bi bi-trash-fill"></i></a></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
