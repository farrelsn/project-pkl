...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" class="row g-3" action="{{ route('pegawai_admin.update',[$pegawai->id]) }}" class="forms-sample">
                @csrf
                ...
                <div class="col-12 text-end mt-2">
                    ...
                    <a href="{{ route('pegawai_admin') }}" class="btn btn-sm btn-dark mb-0">Back</a>
                </div>
            </form>
        </div>
    </div>
