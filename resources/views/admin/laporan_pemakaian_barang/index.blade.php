...
@section('content')
    ...
    @endif
      ...
      <div class="card">
        <div class="card-body">
          <div class="row mb-4">
            <form action="{{ route('laporan_pemakaian_barang_admin.action') }}" method="POST">
              @csrf
              <div class="row g-3">
                <div class="col">
              ...
              <div class="row mt-3">
                <div class="col">
                  ...
                  <a href="{{ route('laporan_pemakaian_barang_admin') }}" class="btn btn-secondary">Reset</a>
            ...
            <table id="example" class="display" style="width: 100%" cellspacing="0">
                ...
                <tbody style="white-space: nowrap">
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-danger btn-sm" href="{{ route('laporan_pemakaian_barang_admin.delete', [$item->id]) }}" onclick="return confirm('Apa anda yakin ingin menghapusnya?')"><i class="fa-solid fa-trash-can"></i></a></td></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
