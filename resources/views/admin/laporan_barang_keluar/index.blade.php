            ...
            <table id="example" class="display" style="width: 100%" cellspacing="0">
                ...
                <tbody style="white-space: nowrap">
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-danger btn-sm" href="{{ route('laporan_barang_keluar_admin.delete', [$item->id]) }}" onclick="return confirm('Apa anda yakin ingin menghapusnya?')"><i class="fa-solid fa-trash-can"></i></a></td></td>
                  </tr>
                  @endforeach
                </tbody>
            </table>
