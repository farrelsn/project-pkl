...
class BarangKeluarController extends Controller
{
    ...
    public function index()
    {
        ...
        if(Auth::user()->level == "admin"){
            ...
            return view('admin.barang_keluar.index', ['title' => 'Daftar Pemakaian Barang', 'barang_keluar' => $barang_keluar, 'admin' => $admin, 'kategori_barang' => $kategori_barang, 'tgl' => $tgl, 'barang' => $barang, 'lokasi' => $lokasi]);
        }
        else if (Auth::user()->level == "user"){
            $user = User::where('username', Auth::user()->username)->first();
            return view('user.barang_keluar.index', ['title' => 'Daftar Pemakaian Barang', 'barang_keluar' => $barang_keluar, 'user' => $user, 'kategori_barang' => $kategori_barang, 'tgl' => $tgl, 'barang' => $barang, 'lokasi' => $lokasi]);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        $db = tb_barang_keluar::create([
            ...
            'stok_akhir' => tb_barang::where('nama_barang', $request->nama_barang)->first()->stok - $request->jumlah_barang,
    ...
    //     $lokasi = tb_lokasi::all();
    //     $tgl = date('d-m-Y');
    //     $pdf = PDF::loadview('admin.barang_keluar.print', ['barang_keluar' => $barang_keluar, 'kategori_barang' => $kategori_barang, 'tgl' => $tgl, 'barang' => $barang, 'lokasi' => $lokasi]);
    //     return $pdf->stream();
    // }
