...
class LaporanPemakaianBarangExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    */
    public function collection()
    {
        if($this->tgl_awal == null && $this->tgl_akhir == null)
            return tb_laporan_pemakaian_barang::query()->get(['tanggal_keluar', 'nama_barang', 'kategori_barang', 'stok_awal', 'jumlah','stok_akhir' ,  'created_at'])->sortBy('tanggal_keluar');
        else if($this->tgl_awal != null && $this->tgl_akhir != null)
            return tb_laporan_pemakaian_barang::query()->whereBetween('tanggal_keluar', [$this->tgl_awal, $this->tgl_akhir])->get(['tanggal_keluar', 'nama_barang', 'kategori_barang', 'stok_awal','jumlah', 'stok_akhir' ,  'created_at'])->sortBy('tanggal_keluar');
    }
